...
using static IwaraDownloader.Helper.MaxDownloads;
using static IwaraDownloader.Helper.SetDownloadsFolder;
    ...
    sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched (LaunchActivatedEventArgs e)
        {
            if (e.Kind == ActivationKind.Launch)
            {
                ...
                var appbar = CoreApplication.GetCurrentView().TitleBar;
                appbar.ExtendViewIntoTitleBar = true;

                await EnsureFolderExits();

                if (!WhetherInitialized())
                    SetCount(3);
            }
